        ...
        {allSlides.map((slide, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Register Now Button - Bottom Center */}
              <div className="absolute bottom-0 left-0 right-0 z-20 flex justify-center items-center pb-8 md:pb-12 lg:pb-16 xl:pb-20">
                <Link
                  href="/register"
                  className="group relative inline-flex items-center justify-center px-5 py-3 md:px-8 md:py-3 overflow-hidden font-bold text-white rounded-md transition-all duration-300 shadow-xl hover:shadow-2xl"
                  style={{ backgroundColor: '#3b3bb7' }}
                >
                  {/* Pulsing ring effect */}
                  <span className="absolute inset-0 rounded-md animate-ping-slow opacity-75" 
                        style={{ backgroundColor: '#3b3bb7' }}></span>
                  
                  {/* Second pulsing ring with delay */}
                  <span className="absolute inset-0 rounded-md animate-ping-slower opacity-50" 
                        style={{ backgroundColor: '#3b3bb7' }}></span>
                  
                  {/* Inner white pulse effect */}
                  <span className="absolute inset-0 bg-white/20 rounded-md animate-pulse-soft"></span>
                  
                  {/* Button text with responsive sizing */}
                  <span className="relative text-sm md:text-base lg:text-lg xl:text-xl font-semibold tracking-wide z-10">
                    Register Now
                  </span>
                </Link>
              </div>
